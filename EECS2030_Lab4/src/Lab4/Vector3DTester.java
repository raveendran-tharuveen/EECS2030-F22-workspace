...
class Vector3DTester {
	...
	void testSetY() {
		Vector3D vect = new Vector3D(5, 6.0, 7.0); 
		vect.setY(99.0);
		boolean equal = Math.abs(99.0 - vect.getY()) < 0.00001;
		String message = "getY() or setY() is wrong/missing";
		assertTrue(equal, message);
	}	
	@Test
	void testSetZ() {
	...
	@Test
	void testAttributeType2() {
		Vector3D vect = new Vector3D(0, 0, 0); 
		boolean equal = (((Object) vect.getY()).getClass().getSimpleName().compareTo("Double") == 0);
		String message = "Type of y is not double";
		assertTrue(equal, message);
	}	
	@Test
	void testAttributeType3() {
		Vector3D vect = new Vector3D(0, 0, 0); 
		boolean equal = (((Object) vect.getZ()).getClass().getSimpleName().compareTo("Double") == 0);
		String message = "Type of z is not double";
		assertTrue(equal, message);
	}	
	@Test
	void testCnstr2() {
	...
	void testCnstr3() {
		...
		Vector3D vect2 = new Vector3D(x, y, z); 
